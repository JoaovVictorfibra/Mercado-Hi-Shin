...
public class TelaLogin extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(8, 8, 8)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        f.setSenha(new String(senha.getPassword()));
        
        f = FuncionarioJPA.validarFuncionario(f);
        
        if(f != null){
            JOptionPane.showMessageDialog(null,"Funcionario: " + f.getNivel() + " " + f.getLogin() +" autenticado com sucesso");
            TelaPrincipal p = new TelaPrincipal(f);
            p.setVisible(true);
            this.dispose();
        }else{
